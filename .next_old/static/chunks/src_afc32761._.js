...
__turbopack_context__.s({
    "cn": (()=>cn),
    "createGenericCollege": (()=>createGenericCollege)
});
...
function createGenericCollege(name) {
    return {
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyBIEN6oMIHWLaMe6HEL2rlittnxgpKkamc"),
    authDomain: ("TURBOPACK compile-time value", "edupath-navigator-l43jb.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "edupath-navigator-l43jb"),
    storageBucket: ("TURBOPACK compile-time value", "edupath-navigator-l43jb.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "998607387069"),
    appId: ("TURBOPACK compile-time value", "1:998607387069:web:936d35b8321d31c8b77ad4"),
...
__turbopack_context__.s({
    ...
    "logOut": (()=>logOut),
    "onAuthStateChangeWrapper": (()=>onAuthStateChangeWrapper),
...
async function signUp(data) {
    ...
    const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
...
async function signIn(email, password) {
    const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ac__as__signInWithEmailAndPassword$3e$__["signInWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
...
function onAuthStateChangeWrapper(callback) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], callback);
}
...
async function sendPasswordReset(email) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__a6__as__sendPasswordResetEmail$3e$__["sendPasswordResetEmail"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
{
__turbopack_context__.s({
    "getBookmarkedResources": (()=>getBookmarkedResources),
    "getSavedCareerPaths": (()=>getSavedCareerPaths),
    "getSavedColleges": (()=>getSavedColleges),
    "isCareerPathSaved": (()=>isCareerPathSaved),
    "isCollegeSaved": (()=>isCollegeSaved),
    "isResourceBookmarked": (()=>isResourceBookmarked),
    "saveCareerPath": (()=>saveCareerPath),
    "saveCollege": (()=>saveCollege),
    "toggleBookmarkResource": (()=>toggleBookmarkResource),
    "unsaveCareerPath": (()=>unsaveCareerPath),
    "unsaveCollege": (()=>unsaveCollege)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$firestore$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase/client.ts [app-client] (ecmascript)");
;
;
async function saveCollege(userId, college) {
    const savedCollegeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedColleges', college.id);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(savedCollegeRef, {
        college,
        savedAt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].now()
    });
}
async function unsaveCollege(userId, collegeId) {
    const savedCollegeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedColleges', collegeId);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDoc"])(savedCollegeRef);
}
async function getSavedColleges(userId) {
    const savedCollegesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedColleges');
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(savedCollegesRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('savedAt', 'desc'));
...
async function isCollegeSaved(userId, collegeId) {
    const savedCollegeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedColleges', collegeId);
    const docSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(savedCollegeRef);
 ...
 */ function generatePathId(pathName) {
    return pathName.toLowerCase().replace(/[^a-z0-9]/g, '-');
}
async function saveCareerPath(userId, path) {
    const pathId = generatePathId(path.name);
    const savedPathRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedCareerPaths', pathId);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(savedPathRef, {
        path,
        savedAt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].now()
    });
}
async function unsaveCareerPath(userId, pathName) {
    const pathId = generatePathId(pathName);
    const savedPathRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedCareerPaths', pathId);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDoc"])(savedPathRef);
}
async function getSavedCareerPaths(userId) {
    const savedPathsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedCareerPaths');
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(savedPathsRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('savedAt', 'desc'));
    const querySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(q);
    return querySnapshot.docs.map((doc)=>{
        const data = doc.data();
        return data.path;
...
async function isCareerPathSaved(userId, pathName) {
    const pathId = generatePathId(pathName);
    const savedPathRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId, 'savedCareerPaths', pathId);
    const docSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(savedPathRef);
    return docSnap.exists();
}
async function toggleBookmarkResource(userId, resourceId) {
    ...
    const currentBookmarks = userData.bookmarkedResources || [];
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userRef, {
        bookmarkedResources: updatedBookmarks
    }, {
        merge: true
    });
}
async function getBookmarkedResources(userId) {
    const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId);
    const userSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(userRef);
    if (!userSnap.exists()) {
        return [];
...
async function isResourceBookmarked(userId, resourceId) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$firestore$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase/database.ts [app-client] (ecmascript)");
;
...
const AuthProvider = ({ children })=>{
    ...
    const [savedColleges, setSavedColleges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [savedCareerPaths, setSavedCareerPaths] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [quizAnswers, setQuizAnswers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [parentQuizAnswers, setParentQuizAnswers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const clearState = ()=>{
        setUser(null);
        setUserProfile(null);
        setQuizAnswers(null);
    ...
    const setGuestProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[setGuestProfile]": (type)=>{
            const guestProfile = {
                uid: 'guest',
                name: 'Guest',
    ...
    }["AuthProvider.useCallback[setGuestProfile]"], [
        router
    ]);
    const updateQuizAnswers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateQuizAnswers]": async (answers)=>{
            if (user && userProfile?.userType === 'student') {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.uid, {
                        quizAnswers: answers
                    });
                    setQuizAnswers(answers);
                    setUserProfile({
                        "AuthProvider.useCallback[updateQuizAnswers]": (prev)=>prev ? {
                                ...prev,
                                quizAnswers: answers
                            } : null
                    }["AuthProvider.useCallback[updateQuizAnswers]"]);
                } catch (error) {
    ...
    const updateParentQuizAnswers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateParentQuizAnswers]": async (answers)=>{
            if (user && userProfile?.userType === 'parent') {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.uid, {
                        parentQuizAnswers: answers
                    });
                    setParentQuizAnswers(answers);
                    setUserProfile({
                        "AuthProvider.useCallback[updateParentQuizAnswers]": (prev)=>prev ? {
                                ...prev,
                                parentQuizAnswers: answers
                            } : null
                    }["AuthProvider.useCallback[updateParentQuizAnswers]"]);
                } catch (error) {
                    console.error("Failed to save parent quiz answers:", error);
                }
            } else if (userProfile?.userType === 'parent') {
                setParentQuizAnswers(answers);
                setUserProfile({
                    "AuthProvider.useCallback[updateParentQuizAnswers]": (prev)=>prev ? {
                            ...prev,
    ...
    const resetQuizAnswers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[resetQuizAnswers]": async ()=>{
            if (user && userProfile?.userType === 'student') {
                try {
                    // Use deleteField() to properly remove the field from Firestore
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.uid, {
                        quizAnswers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteField"])()
                    });
                    setQuizAnswers(null);
                    setUserProfile({
                        "AuthProvider.useCallback[resetQuizAnswers]": (prev)=>prev ? {
                                ...prev,
                                quizAnswers: undefined
                            } : null
                    }["AuthProvider.useCallback[resetQuizAnswers]"]);
                } catch (error) {
    ...
    const updateUserProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateUserProfile]": async (data)=>{
            if (user) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.uid, data);
                const updatedProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(user.uid);
                setUserProfile(updatedProfile);
            } else {
                // Handle guest profile update
                setUserProfile({
                    "AuthProvider.useCallback[updateUserProfile]": (prev)=>prev ? {
                            ...prev,
                            ...data
                        } : null
    ...
    const toggleSaveCollege = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[toggleSaveCollege]": async (college)=>{
            const isSaved = savedColleges.some({
                "AuthProvider.useCallback[toggleSaveCollege].isSaved": (c)=>c.id === college.id
            }["AuthProvider.useCallback[toggleSaveCollege].isSaved"]);
            if (user) {
                // Authenticated user - persist to Firestore
                try {
                    if (isSaved) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unsaveCollege"])(user.uid, college.id);
                        setSavedColleges({
                            "AuthProvider.useCallback[toggleSaveCollege]": (prev)=>prev.filter({
                                    "AuthProvider.useCallback[toggleSaveCollege]": (c)=>c.id !== college.id
                                }["AuthProvider.useCallback[toggleSaveCollege]"])
                        }["AuthProvider.useCallback[toggleSaveCollege]"]);
                    } else {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveCollege"])(user.uid, college);
                        setSavedColleges({
                            "AuthProvider.useCallback[toggleSaveCollege]": (prev)=>[
                                    ...prev,
                                    college
                                ]
                        }["AuthProvider.useCallback[toggleSaveCollege]"]);
                ...
                setSavedColleges({
                    "AuthProvider.useCallback[toggleSaveCollege]": (prev)=>isSaved ? prev.filter({
                            "AuthProvider.useCallback[toggleSaveCollege]": (c)=>c.id !== college.id
                        }["AuthProvider.useCallback[toggleSaveCollege]"]) : [
                            ...prev,
                            college
    ...
    const isCollegeSaved = (collegeId)=>{
        return savedColleges.some((c)=>c.id === collegeId);
    };
    const toggleSaveCareerPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[toggleSaveCareerPath]": async (path)=>{
            const isSaved = savedCareerPaths.some({
                "AuthProvider.useCallback[toggleSaveCareerPath].isSaved": (p)=>p.name === path.name
            }["AuthProvider.useCallback[toggleSaveCareerPath].isSaved"]);
            if (user) {
                // Authenticated user - persist to Firestore
                try {
                    if (isSaved) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unsaveCareerPath"])(user.uid, path.name);
                        setSavedCareerPaths({
                            "AuthProvider.useCallback[toggleSaveCareerPath]": (prev)=>prev.filter({
                                    "AuthProvider.useCallback[toggleSaveCareerPath]": (p)=>p.name !== path.name
                                }["AuthProvider.useCallback[toggleSaveCareerPath]"])
                        }["AuthProvider.useCallback[toggleSaveCareerPath]"]);
                    } else {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveCareerPath"])(user.uid, path);
                        setSavedCareerPaths({
                            "AuthProvider.useCallback[toggleSaveCareerPath]": (prev)=>[
                                    ...prev,
                                    path
                                ]
                        }["AuthProvider.useCallback[toggleSaveCareerPath]"]);
                ...
                // Guest user - only update local state
                setSavedCareerPaths({
                    "AuthProvider.useCallback[toggleSaveCareerPath]": (prev)=>isSaved ? prev.filter({
                            "AuthProvider.useCallback[toggleSaveCareerPath]": (p)=>p.name !== path.name
                        }["AuthProvider.useCallback[toggleSaveCareerPath]"]) : [
                            ...prev,
                            path
    ...
    const isCareerPathSaved = (pathName)=>{
        return savedCareerPaths.some((p)=>p.name === pathName);
    };
    const handleLogout = async ()=>{
        if (user) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logOut"])();
        }
        clearState();
        router.push('/');
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChangeWrapper"])({
                "AuthProvider.useEffect.unsubscribe": async (authUser)=>{
                    ...
                    if (authUser && authUser.emailVerified) {
                        ...
                        const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(authUser.uid);
                        ...
                        try {
                            ...
                            const [colleges, paths] = await Promise.all([
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSavedColleges"])(authUser.uid),
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSavedCareerPaths"])(authUser.uid)
                            ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        value: contextValue,
        children: loading && pathname !== '/' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthLoadingSkeleton, {}, void 0, false, {
            fileName: "[project]/src/hooks/use-auth.tsx",
            lineNumber: 352,
            columnNumber: 38
        }, this) : children
...
_s(AuthProvider, "eOv0IaImumju025112bmNjE8jS4=", false, function() {
    return [
...
var _c, _c1;
__turbopack_context__.k.register(_c, "AuthLoadingSkeleton");
...
//# sourceMappingURL=src_afc32761._.js.map